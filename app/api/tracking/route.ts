...
//     // Get user's active bookings for tracking
...
//     // Get active buses with recent positions
...
//         const latestPosition = bus.positions[0]
...
//             address: `Lat: ${latestPosition.latitude.toFixed(4)}, Lng: ${latestPosition.longitude.toFixed(4)}`
//           },
//           nextStop: 'Next Stop', // You would calculate this based on route and position
//           estimatedArrival: currentSchedule?.arrivalTime || 'Unknown',
//           status: getRandomStatus(), // You would determine this based on schedule and position
//           capacity: {
//             occupied: Math.floor(Math.random() * bus.capacity),
//             total: bus.capacity
//           },
