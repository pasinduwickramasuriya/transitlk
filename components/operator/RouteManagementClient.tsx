...
// import { Plus, Route, MapPin, Clock, Activity, Calendar, Users } from 'lucide-react'
...
// function StatsCard({ title, value, icon: Icon, color, bgColor, subtitle }: StatsCardProps) {
//   return (
//     <Card className="hover:shadow-md transition-shadow cursor-pointer">
//       <CardContent className="p-4">
//         <div className="flex items-center space-x-3">
//           <div className={`p-2 rounded-lg ${bgColor} transition-colors`}>
