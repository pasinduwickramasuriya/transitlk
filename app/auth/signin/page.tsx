...
//                       <div className={`absolute left-4 top-1/2 transform -translate-y-1/2 transition-all duration-200 ${focusedField === 'email' ? 'text-cyan-600 scale-110' : 'text-gray-500'
//                         }`}>
...
//                     </Label>
//                     <div className="relative group">
//                       <div className={`absolute left-4 top-1/2 transform -translate-y-1/2 transition-all duration-200 ${focusedField === 'password' ? 'text-cyan-600 scale-110' : 'text-gray-500'
//                         }`}>
...
//                   <p className="text-slate-600 text-lg font-medium">Welcome back! Enter your credentials to continue</p>
//                 </div>
...
//                         focusedField === 'email' ? 'text-violet-600 scale-110' : 'text-slate-500'
//                       }`}>
//                         <Mail className="h-5 w-5" />
//                       </div>
//                       <Input
...
//                     <div className="relative group">
//                       <div className={`absolute left-4 top-1/2 transform -translate-y-1/2 transition-all duration-200 ${
//                         focusedField === 'password' ? 'text-violet-600 scale-110' : 'text-slate-500'
//                       }`}>
//                         <Lock className="h-5 w-5" />
//                       </div>
//                       <Input
