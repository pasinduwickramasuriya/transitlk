...
// // Define User interface for typing
// interface User {
//   id: string
//   name?: string | null
//   email?: string | null
...
//   // User state with explicit typing allowing null or User
...
//                   className={`group relative flex items-center px-3 xl:px-5 py-2 xl:py-3 rounded-2xl text-sm font-semibold transition-all duration-300 ${activeItem === item.name
...
//                     }`}
//                 >
//                   <item.icon className={`h-4 w-4 mr-1 xl:mr-2 transition-transform duration-300 group-hover:scale-110 ${activeItem === item.name ? 'text-rose-500' : 'text-slate-400 group-hover:text-rose-500'
//                     }`} />
...
//                     setIsMenuOpen(false)
//                   }}
//                   className={`group flex items-center px-4 sm:px-5 py-3 sm:py-4 rounded-xl sm:rounded-2xl text-sm sm:text-base font-semibold transition-all duration-300 ${activeItem === item.name
...
//                 >
//                   <div className={`w-8 sm:w-10 h-8 sm:h-10 rounded-lg sm:rounded-xl flex items-center justify-center mr-3 sm:mr-4 transition-all duration-300 ${activeItem === item.name
...
//                     }`}>
//                     <item.icon
//                       className={`h-4 sm:h-5 w-4 sm:w-5 ${activeItem === item.name ? 'text-white' : 'text-slate-500 group-hover:text-white'
//                         }`}
//                     />
//                   </div>
